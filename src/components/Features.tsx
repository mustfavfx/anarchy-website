  ...
  const features = [
    {
      ...
      titleAr: 'أتمتة مبنية على العقد',
      description: 'Build complex AI workflows with our intuitive drag-and-drop node editor. Connect processing nodes to create powerful automation chains for your architectural projects.',
      descriptionAr: 'أنشئ سير عمل معقدة للذكاء الاصطناعي باستخدام محرر العقد السحب والإفلات. اربط عقد المعالجة لإنشاء سلاسل أتمتة قوية لمشاريعك المعمارية.',
      size: 'large' as const,
    ...
    },
    {
      ...
      titleAr: 'تكامل متعدد APIs',
      description: 'Seamlessly integrated with Segmind, KIE (Krita AI), and Supabase for powerful backend capabilities and flexible deployment options.',
      descriptionAr: 'متكامل بسلاسة مع Segmind و KIE (Krita AI) و Supabase لقدرات خلفية قوية وخيارات نشر مرنة.',
    ...
    },
    {
      ...
      titleAr: 'الذكاء المعماري',
      description: 'Master Builder workflow - from initial concept sketches to final execution renders. AI-powered transformation of architectural vision into reality.',
      descriptionAr: 'سير عمل Master Builder - من الرسومات التخطيطية الأولية إلى العروض النهائية. تحويل الرؤية المعمارية إلى واقع بقوة الذكاء الاصطناعي.',
      size: 'wide' as const,
    ...
    },
    {
      ...
      titleAr: 'معالجة آمنة',
      description: 'Enterprise-grade security with encrypted data transmission and local processing options.',
      descriptionAr: 'أمان على مستوى المؤسسات مع تشفير نقل البيانات وخيارات المعالجة المحلية.',
      size: 'small' as const,
    ...
    },
    {
      ...
      titleAr: 'هجين سحابي ومحلي',
      description: 'Choose between cloud processing for speed or local execution for privacy.',
      descriptionAr: 'اختر بين المعالجة السحابية للسرعة أو التنفيذ المحلي للخصوصية.',
      size: 'small' as const,
    ...
    {
      icon: Sparkles,
      title: 'AI Model Variety',
      titleAr: 'تنوع نماذج الذكاء الاصطناعي',
      description: 'Access FLUX, Ideogram, and custom-trained models for specialized architectural outputs.',
      descriptionAr: 'الوصول إلى FLUX و Ideogram والنماذج المدربة مخصصًا للمخرجات المعمارية المتخصصة.',
      size: 'medium' as const,
